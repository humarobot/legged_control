...
class ArmEePositionConstraint final : public StateConstraint {
 public:
  ...
  ArmEePositionConstraint(const EndEffectorKinematics<scalar_t>& endEffectorKinematics);
  ~ArmEePositionConstraint() override = default;
  ArmEePositionConstraint* clone() const override { return new ArmEePositionConstraint(*endEffectorKinematicsPtr_); }
